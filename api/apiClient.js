...
export const getUsers = async () => {
  try {
    const res = await fetch("https://campus-psi.vercel.app/api/users", {
      method: "GET",
      headers: {
...
export const getFilterUsers = async (val, id) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/users?val=${val}&user=${id}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const getUser = async (query, value) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/users?${query}=${value}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const getUserById = async (id) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/users/${id}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const logUser = async (email, password) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/login?email=${email}&password=${password}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const getUserDetails = async (id) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/details?id=${id}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const getCourses = async (body) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/course?prefix=${body}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const joinCourse = async (userId, courseCode, isJoining) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/usercourse`, {
      method: "PUT",
      headers: {
        "Content-type": "application/json"
      },
...
export const getConnections = async (search, email) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/friends?prefix=${search}&email=${email}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const addConnections = async (body) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/friends`, {
      method: "PUT",
      headers: {
        "Content-type": "application/json"
      },
...
export const createGroup = async (body) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/group`, {
      method: "POST",
      headers: {
        "Content-type": "application/json"
      },
...
export const getGroup = async (id) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/group?id=${id}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const getCourseGroups = async (course, search) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/group?course=${course}&prefix=${search}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const getFilteredGroups = async (search) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/group?prefix=${search}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const updateGroup = async (id, body) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/group/${id}`, {
      method: "PUT",
      headers: {
        "Content-type": "application/json"
      },
...
export const removeGroupMember = async (groupId, userId) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/group/${groupId}`, {
      method: "DELETE",
      headers: {
        "Content-type": "application/json"
      },
...
export const createNotif = async (body) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/notifications`, {
      method: "POST",
      headers: {
        "Content-type": "application/json"
      },
...
export const getNotifs = async (email) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/notifications?receiver=${email}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const addMessage = async (body) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/message`, {
      method: "POST",
      headers: {
        "Content-type": "application/json"
      },
...
export const getGroupMessages = async (groupId) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/message?groupId=${groupId}`, {
      method: "GET",
      headers: {
        "Content-type": "application/json"
      },
...
export const editMessage = async (messageId, body) => {
  try {
    const res = await fetch(`https://campus-psi.vercel.app/api/message?messageId=${messageId}`, {
      method: "PUT",
      headers: {
        "Content-type": "application/json"
      },
